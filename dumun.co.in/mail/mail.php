...
$recipientEmail             = 'info@dumun.co.in'; // REQUIRED value.
$recipientName              = 'DUMUN 2016';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Contact Form'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'DUMUN 2016';                // REQUIRED value. This is used when a name or email is not collected from the website form
